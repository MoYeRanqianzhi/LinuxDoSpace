...
// CheckPublicAvailability exposes the same availability answer used by the
// authenticated write path so the public UI does not advertise prefixes that
// are already occupied by live infrastructure records.
