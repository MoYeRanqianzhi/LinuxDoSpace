...
func applyDomainAllocationPurchaseTx(ctx context.Context, tx *queryTx, order model.PaymentOrder, appliedAt time.Time) error {
...
func generateRandomAllocationPrefixTx(ctx context.Context, tx *queryTx, managedDomainID int64, length int) (string, error) {
