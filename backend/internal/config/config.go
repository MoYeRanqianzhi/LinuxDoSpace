...
// defaultAdminPassword is the temporary fallback second-factor password used by
// the admin console until a deployment overrides APP_ADMIN_PASSWORD.
const defaultAdminPassword = "linuxdospace-admin-2026"
...
func Load() (Config, error) {
	cfg := Config{
		App: AppConfig{
			...
			AdminUsernames:        splitCSV(getEnv("APP_ADMIN_USERNAMES", "MoYeRanQianZhi,user2996")),
			AdminPassword:         getEnv("APP_ADMIN_PASSWORD", defaultAdminPassword),
